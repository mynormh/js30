...
console.log(`All the inventors lived for ${totalYearsLived} years`);
...
//Execute in DevTools on page https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris
...
const lastNameOrder = people.sort((a, b) => {
